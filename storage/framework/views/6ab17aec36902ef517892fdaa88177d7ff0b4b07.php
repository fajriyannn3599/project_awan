            ...
            <div class="row">
                <div class="col-3">
                    <div class="card-header">
                        Tabel Order <?php echo e($no_nota); ?>
                                ...
                                <td>
                                    <form action="/dashboard/orders/<?php echo e($order->id); ?>" method="post"
                                        ...
                                        <input type="hidden" class="form-control" name="no_nota" required
                                             value="<?php echo e($order->no_nota); ?>">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\SEMESTER 5\kasirku-main\resources\views/dashboard/orders/index.blade.php ENDPATH**/ ?>