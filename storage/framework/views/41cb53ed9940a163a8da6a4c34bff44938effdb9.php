                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="no_nota" required
                                placeholder="Masukkan Nama Kategori..." value="<?php echo e($no_nota); ?>" readonly>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama_pembeli" required
                                value="<?php echo e($transaction->nama_pembeli); ?>" readonly>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="total_harga" id="total" required
                                value="<?php echo e($total_harga); ?>" readonly>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\SEMESTER 5\kasirku-main\resources\views/dashboard/cashiers/checkout.blade.php ENDPATH**/ ?>