                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="bayar" name="bayar"
                                ...
                                value="<?php echo e($transaction->bayar); ?>" onchange="Kembalian()">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="kembalian" name="kembalian"
                                placeholder="Masukkan.." value="<?php echo e($transaction->kembalian); ?>" readonly>
                        </div>
                    </div>
                    <hr>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\Documents\SEMESTER 5\kasirku-main\resources\views/dashboard/transactions/edit.blade.php ENDPATH**/ ?>