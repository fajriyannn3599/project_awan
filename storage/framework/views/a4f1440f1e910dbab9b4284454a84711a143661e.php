    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                <li class="nav-item">
                    <a class="nav-link  <?php echo e($active === 'beranda' ? 'active' : ''); ?>" aria-current="page"
                        href="/dashboard">Beranda</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo e($active === 'data' ? 'active' : ''); ?>" href="#"
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e($active === 'cashier' ? 'active' : ''); ?>" href="/dashboard/cashier">Sistem
                        Kasir</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e($active === 'rekap' ? 'active' : ''); ?>"
...
<?php /**PATH C:\Users\LENOVO\Documents\SEMESTER 5\kasirku-main\resources\views/dashboard/partials/navbar.blade.php ENDPATH**/ ?>